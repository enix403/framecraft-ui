<div class="flex rounded-xl overflow-hidden m-10 border border-border flex-1">
    ...
    <div class="form-group">
      ...
      <div class="form-field pt-5">
        <div class="form-control justify-between">
          <button
            type="button"
            class="btn btn-primary w-full bg-gradient-to-r from-pink-600 to-purple-500"
          >
            Create your account
          </button>
        </div>
      ...
      <div class="form-field">
        <div class="form-control">
          <a class="link link-underline-hover link-secondary text-sm">
  ...
  <div class="flex-1">
    <img src="/hero3.jpg" class="w-full max-w-full h-full object-cover" />
  </div>
</div>
